...
static esp_bt_uuid_t heart_rate_service_uuid = {
    .len = ESP_UUID_LEN_16,
    .uuid = {
        .uuid16 = 0x180A
    }
...
//static esp_bt_uuid_t device_information_service_uuid = {
//    .len = ESP_UUID_LEN_16,
//    .uuid = {
//        .uuid16 = 0x180D
//    }
...
static esp_bt_uuid_t heart_rate_measure_uuid = {
    .len = ESP_UUID_LEN_16,
    .uuid = {
        .uuid16 = 0x2a37
    }
...
static void gattc_profile_event_handler(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if, esp_ble_gattc_cb_param_t *param)
{
    ...
    case ESP_GATTC_CFG_MTU_EVT:
        ...
        esp_ble_gattc_search_service(gattc_if, param->cfg_mtu.conn_id, &heart_rate_service_uuid);
        //esp_ble_gattc_search_service(gattc_if, param->cfg_mtu.conn_id, &device_information_service_uuid);
        break;
    ...
    case ESP_GATTC_SEARCH_CMPL_EVT:
        ...
        if (get_server){
            ...
            esp_gatt_status_t status = esp_ble_gattc_get_attr_count( gattc_if,
                                                                     ...
                                                                     INVALID_HANDLE,
                                                                     &count);
            ESP_LOGI(GATTC_TAG, "Attribute count: %d", count);
